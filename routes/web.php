...
/* Landing Page */
    Route::get('/', 'Acl\Tenant\SessionController@getLogin');
...
/* Policies */
    ...
    Route::get('policy/addBulk', ['as' => 'policy.add.bulk', 'uses' => 'PolicyController@addBulk']);
    Route::post('policy/addBulk', ['as' => 'post.policy.add', 'uses' => 'PolicyController@postBulk']);
...
/* System Settings */
    ...
    // SMS Languages
    Route::resource('TenantLanguages', 'TenantLanguageController');
    // Tenant Sales
