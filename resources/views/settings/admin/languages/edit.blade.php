...
<!-- Page Title -->
@section('title')SMS Languages @stop
...
<!-- Page Header -->
@section('header')Edit SMS Language @stop

<!-- Page Description -->
@section('desc')Edit SMS Language Details @stop

<!-- Active Link -->
@section('active')SMS Languages @stop
    ...
    <div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('languages.update', array($language->id)) }}" method="POST" accept-charset="UTF-8">
                    <input type="hidden" name="_method" value="PUT">
                    <input name="_token" value="{{ csrf_token() }}" type="hidden">
                    
                    <div class="wizard-header">
                        <h3 class="wizard-title">
                            Edit SMS Language Details
                        </h3>
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="name" value="{{ $language->language }}" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
