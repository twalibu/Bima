...
<!-- Page Header -->
@section('header')Add SMS Language @stop

<!-- Page Description -->
@section('desc')Create New SMS Language @stop
	...
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('TenantLanguages.store') }}" method="POST" accept-charset="UTF-8">
                    <input name="_token" value="{{ csrf_token() }}" type="hidden">
                    
                    <div class="wizard-header">
                        <h3 class="wizard-title">
                            New SMS Language Registration
                        </h3>
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            <label class="control-label">Select SMS Language</label>
                                            <select class="form-control" name="language">
                                                <option disabled="" selected=""></option>
                                                @foreach($languages as $language)
                                                    <option value="{{ $language->id }}"
                                                        @if($language->id == old('name'))
                                                            selected=""
                                                        @endif
