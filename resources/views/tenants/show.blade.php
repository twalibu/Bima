		...
		<div class="box box-info">
        	<div class="box-body">
        		<a class="btn btn-app" href="{{ route('tenant.subscription', array($tenant->subscription->id)) }}">
              	...
              	<a class="btn btn-app">
              		<span class="badge bg-purple">{{ $tenant->policies->count() }}</span>
                	<i class="fa fa-check-square"></i> Tenant Total Policies
              	</a>
	...
	<div class="col-md-9">
	  	<div class="nav-tabs-custom">
	    	<ul class="nav nav-tabs">
	      		<li class="active"><a href="#billing" data-toggle="tab">Tenant Bills</a></li>
	      		<li><a href="#contacts" data-toggle="tab">Tenant Contacts</a></li>
			    	 ...
			    	 <table id="xa" class="table table-bordered table-striped table-hover">
		                ...
		                <tbody>                
		                	@foreach ($tenant->bills as $bill)
			                  	<tr>
				                    <td>{{ date("F", mktime(0, 0, 0, $bill->month, 1)) }}, {{ $bill->year}}</td>
				                    <td>{{ number_format($bill->sms_count) }} SMS</td>
				                    <td>Tsh {{ number_format($bill->amount,2) }}/-</td>
			                  	</tr>                
		                 	@endforeach
		                </tbody>
