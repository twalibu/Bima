...
<!-- Page Header -->
@section('header')Edit Policy @stop

<!-- Page Description -->
@section('desc')Edit Policy's Details @stop

<!-- Active Link -->
@section('active')Polices @stop
	...
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('policies.update', array($policy->id)) }}" method="POST" accept-charset="UTF-8">
                    <input type="hidden" name="_method" value="PUT">
                    <input name="_token" value="{{ csrf_token() }}" type="hidden">
                    
                    <div class="wizard-header">
                        <h3 class="wizard-title">
                            Edit Policy's Details
                        </h3>
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="policy_number" value="{{ $policy->policy_number }}" type="text" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="client_name" value="{{ $policy->client_name }}" type="text" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="phone_number" value="{{ $policy->phone_number }}" type="number" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            ...
                                            <input name="renewal_date" value="{{ $policy->expiration_date }}" type="date" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
