...
class BulkController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tools.tenant.bulk.index', compact('groups'));
    }
    ...
    {
        return view('tools.tenant.bulk.create');
    }
    ...
    public function add($id)
    {
        ...
        return view('tools.tenant.bulk.add', compact('group'));
    }
    ...
    {
        $group = Group::findorfail($id);
        $contacts = Contact::where('group_id', $group->id)->paginate(100);

        return view('tools.tenant.bulk.show', compact('group', 'contacts'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('tools.tenant.bulk.edit', compact('group'));
    }
